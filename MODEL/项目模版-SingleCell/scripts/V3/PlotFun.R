...
MultiExIPlot_L <- function(
  ...
  plot <- ggplot(
    ...
    labs(x = x.label, y = y.label, fill = NULL,size=22) +
    theme_cowplot()
  ...
  if (flip) {
    plot <- plot +
      ...
      FacetTheme(
        ...
        axis.text.y = element_text(size=22),plot.title=element_text(size=22),
    ...
    plot <- plot +
      ...
      FacetTheme(
        panel.spacing = unit(0, 'lines'),
        panel.background = element_rect(fill = NA, color = "black"),
        axis.text.x = element_text(size=22),plot.title=element_text(size=22),
        strip.text.x = element_text(angle = -90,size=22))+theme(axis.text.y = element_text(size=22))
  }
  if (log) {
    plot <- plot + scale_x_log10()
  }
