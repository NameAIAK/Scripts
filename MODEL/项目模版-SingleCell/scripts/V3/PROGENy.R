...
ggsave('SeJe-EC-progeny_hmap.pdf',progeny_hmap,height=6,width=4)
...
progeny_hmap = pheatmap(t(summarized_kegg_scores_df),fontsize=16, 
                        ...
                        main = "GSVA", angle_col = 0,
                        treeheight_col = 0,  border_color = NA)
ggsave('SeJe-myoFB-gsva_hmap2.pdf',progeny_hmap,height=6,width=10)
...
progeny_hmap = pheatmap(t(summarized_kegg_scores_df),fontsize=16, 
                        ...
                        main = "GSVA", angle_col = 0,
                        treeheight_col = 0,  border_color = NA)
ggsave('SeJe-EC-gsva_hmap2.pdf',progeny_hmap,height=6,width=10)
